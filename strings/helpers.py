...
⏭️ /ilerisar X      - Müziği X sn ileri sarar
⏮️ /gerisar X       - Müziği X sn geri sarar
🔁 /dongu X         - Müziği X kez döngüye alır

💡 Örnek: /ilerisar 15 → 15 saniye ileri

▶️ /oynat /play      - Müziği oynatır (Ör: /oynat Gönül Dağı)
