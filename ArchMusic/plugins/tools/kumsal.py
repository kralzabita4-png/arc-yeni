...
guntag_messages = [
    "Günaydın {user}! 🌞 Umarım harika bir gün geçirirsin!",
    "Selam {user}, günün güzel geçsin! ☀️",
    "Merhaba {user}! Bugün harika bir gün olacak! 🌸",
    "Günaydın {user}! Kahveni almayı unutma ☕",
    "Mutlu sabahlar {user}! 🌷",
    "Harika bir gün seninle olsun {user}! 🌞",
    "Günaydın {user}! Yeni güne merhaba! 🌼",
    "Selam {user}, pozitif enerji dolu bir gün! ✨",
    "Günaydın {user}! Bol kahkaha ve mutluluk dolu bir gün! 😄",
    "Merhaba {user}, bugün her şey yolunda olsun! 🌞",
    "Günaydın {user}! Yeni başlangıçlar için hazır mısın? 🌅",
    "Selam {user}! Güzel bir gün dilerim! 🌸",
    "Günaydın {user}! Bugün kendine iyi bak! 💛",
    "Merhaba {user}! Enerjin yüksek olsun! ⚡",
    "Günaydın {user}! Mutlu ve huzurlu bir gün! 🌻",
    "Selam {user}! Bugün harika şeyler olacak! 🌞",
    "Günaydın {user}! Hayallerin seni bekliyor! ✨",
    "Merhaba {user}! Pozitif düşüncelerle dolu bir gün! 🌼",
    "Günaydın {user}! Kahkaha ve mutluluk seninle olsun! 😄",
    "Selam {user}! Güne enerjik başla! 💪",
    "Günaydın {user}! Gülümse ve keyfini çıkar! 🌞",
    "Merhaba {user}! Bugün sadece güzel şeyler olsun! 🌸",
    "Günaydın {user}! Motivasyon dolu bir gün! ✨",
    "Selam {user}! Şans ve mutluluk seninle olsun! 🌷",
    "Günaydın {user}! Bugün kendini özel hisset! 💛",
    "Merhaba {user}! Güzel bir sabah dilerim! 🌅",
    "Günaydın {user}! Yeni fırsatlar seni bekliyor! 🌞",
    "Selam {user}! Enerjini yüksek tut! ⚡",
    "Günaydın {user}! Pozitif bir başlangıç! 🌼",
    "Merhaba {user}! Kahveni al ve gülümse! ☕",
    "Günaydın {user}! Mutlu anılar biriktir! 🌸",
    "Selam {user}! Bugün her şey yolunda olsun! 🌞",
    "Günaydın {user}! Hayatın tadını çıkar! ✨",
    "Merhaba {user}! Enerji dolu bir sabah! ⚡",
    "Günaydın {user}! Sevgi ve mutluluk dolu bir gün! 💛",
    "Selam {user}! Güzel başlangıçlar seni bekliyor! 🌷",
    "Günaydın {user}! Kahkahalar eksik olmasın! 😄",
    "Merhaba {user}! Pozitif enerji ile dolu bir gün! 🌼",
    "Günaydın {user}! Bugün harika sürprizler var! 🌸",
    "Selam {user}! Mutlu ve huzurlu bir gün! 🌞",
    "Günaydın {user}! Kendine iyi bakmayı unutma! 💛",
    "Merhaba {user}! Yeni fırsatlarla dolu bir gün! ✨",
    "Günaydın {user}! Bol kahkaha ve keyif! 😄",
    "Selam {user}! Güzel bir gün seni bekliyor! 🌸",
    "Günaydın {user}! Hayallerini gerçekleştir! 🌞",
    "Merhaba {user}! Enerjin yüksek olsun! ⚡",
    "Günaydın {user}! Pozitif bir sabah! 🌷",
    "Selam {user}! Mutluluk ve huzur dolu bir gün! 💛",
    "Günaydın {user}! Kahveni al, gülümse ve başla! ☕",
    "Merhaba {user}! Bugün sadece güzel şeyler olsun! 🌸",
    "Günaydın {user}! Yeni başlangıçlara hazır mısın? 🌞"
]
gece_messages = [
    "🌙 {user}, iyi geceler! 😴",
    "💤 {user}, tatlı rüyalar! 🌌",
    "🌟 {user}, güzel uykular dilerim! ✨",
    "🌙 {user}, huzurlu bir uyku dilerim! 😴",
    "💤 {user}, rüyaların en güzelinden olsun! 🌌",
    "🌟 {user}, tatlı uykular! ✨",
    "🌙 {user}, dinlendirici bir gece seni bekliyor! 😴",
    "💤 {user}, yıldızlar sana eşlik etsin! 🌌",
    "🌟 {user}, güzel rüyalar! ✨",
    "🌙 {user}, huzur dolu bir uyku! 😴",
    "💤 {user}, rüyanda mutluluk olsun! 🌌",
    "🌟 {user}, iyi geceler, tatlı rüyalar! ✨",
    "🌙 {user}, gecen keyifli geçsin! 😴",
    "💤 {user}, rüya gibi bir gece! 🌌",
    "🌟 {user}, uyku zamanı geldi! ✨",
    "🌙 {user}, sessiz ve huzurlu bir gece! 😴",
    "💤 {user}, güzel rüyalara yelken aç! 🌌",
    "🌟 {user}, tatlı rüyalar seni bekliyor! ✨",
    "🌙 {user}, iyi geceler ve güzel rüyalar! 😴",
    "💤 {user}, gece sakin ve huzurlu olsun! 🌌",
    "🌟 {user}, uyurken mutlu ol! ✨",
    "🌙 {user}, rüyaların tatlı olsun! 😴",
    "💤 {user}, huzurla uyu! 🌌",
    "🌟 {user}, gecen harika geçsin! ✨",
    "🌙 {user}, tatlı uykular dilerim! 😴",
    "💤 {user}, yıldızlar seninle! 🌌",
    "🌟 {user}, geceyi keyifle geçir! ✨",
    "🌙 {user}, uyku zamanı huzurlu olsun! 😴",
    "💤 {user}, rüyanda mutluluk bul! 🌌",
    "🌟 {user}, iyi geceler! ✨",
    "🌙 {user}, sessiz bir gece olsun! 😴",
    "💤 {user}, güzel rüyalara dal! 🌌",
    "🌟 {user}, uykuya dalarken mutlu ol! ✨",
    "🌙 {user}, huzurlu rüyalar! 😴",
    "💤 {user}, gecen tatlı geçsin! 🌌",
    "🌟 {user}, rüya gibi uykular! ✨",
    "🌙 {user}, tatlı bir uyku çek! 😴",
    "💤 {user}, yıldızlar sana gülümsesin! 🌌",
    "🌟 {user}, uyurken mutlu ol! ✨",
    "🌙 {user}, rüya dolu bir gece! 😴",
    "💤 {user}, iyi geceler, huzurlu ol! 🌌",
    "🌟 {user}, tatlı rüyalara yelken aç! ✨",
    "🌙 {user}, güzel bir uyku dilerim! 😴",
    "💤 {user}, gecen sakin geçsin! 🌌",
    "🌟 {user}, rüyan tatlı olsun! ✨",
    "🌙 {user}, huzurla uyu ve dinlen! 😴",
    "💤 {user}, yıldızlar geceni aydınlatsın! 🌌",
    "🌟 {user}, iyi geceler! ✨",
    "🌙 {user}, tatlı uykular! 😴",
    "💤 {user}, gecen keyifli geçsin! 🌌",
    "🌟 {user}, rüyalarındaki mutluluk seninle olsun! ✨"
]
messages = [
    "Haydi kurta gelde seni bı yiyeyim 🐺",
    "Kurt oyunu basliyor haydi gel 🐺",
    "Kurt senin peşinde, kaçış yok! 🐺",
    "Hazır mısın? Kurt oyunu başlıyor! 🐺",
    "Kurt çağırıyor, haydi gel! 🐺",
    "Beni yakalayabilir misin? 🐺",
    "Kurt seni bekliyor! 🐺",
    "Hadi kurta gel ve maceraya katıl! 🐺",
    "Kurt ormanda seni arıyor! 🐺",
    "Oyuna başlamak için hazırsan gel! 🐺",
    "Kurt seni görmeden duramaz! 🐺",
    "Koş, kurt seni bekliyor! 🐺",
    "Kurt oyununa davetlisin! 🐺",
    "Gecenin efendisi kurt geliyor! 🐺",
    "Seninle oynamak için sabırsızlanıyorum! 🐺",
    "Kurt seni çağırıyor, gel! 🐺",
    "Ormanda kurt bekliyor! 🐺",
    "Hadi eğlence başlasın! 🐺",
    "Kurt oyunu başladı, katıl! 🐺",
    "Sana meydan okuyorum, gel! 🐺",
    "Hadi kurta gel ve eğlen! 🐺",
    "Kurt seni yakalayacak! 🐺",
    "Ormanda macera seni bekliyor! 🐺",
    "Seninle oyun oynamak istiyorum! 🐺",
    "Kurtla yüzleşmeye hazır mısın? 🐺",
    "Haydi gel, macera başlasın! 🐺",
    "Kurt seni bekliyor, acele et! 🐺",
    "Hadi kurta gel ve kazan! 🐺",
    "Ormanda eğlence başlıyor! 🐺",
    "Seninle oyun zamanı! 🐺",
    "Kurt peşinde, dikkat et! 🐺",
    "Gel ve maceraya katıl! 🐺",
    "Kurt oyununa hazır ol! 🐺",
    "Hadi kurta gel ve eğlenceli ol! 🐺",
    "Kurt seni çağırıyor, yakala! 🐺",
    "Ormanda seninle oynayacağım! 🐺",
    "Hazır mısın? Kurt seni bekliyor! 🐺",
    "Gel ve kurtla yüzleş! 🐺",
    "Hadi kurta gel, oyun başlasın! 🐺",
    "Seninle yarışmaya hazırım! 🐺",
    "Kurt oyunu başladı, katıl! 🐺",
    "Ormanda eğlence seni bekliyor! 🐺",
    "Seninle macera zamanı! 🐺",
    "Kurt seni yakalayacak, dikkat et! 🐺",
    "Gel ve maceraya başla! 🐺",
    "Hadi kurta gel ve kazan! 🐺",
    "Kurt oyununa davetlisin, gel! 🐺",
    "Seninle oynayacağım! 🐺",
    "Hazır mısın? Macera başlıyor! 🐺",
    "Gel ve eğlenceye katıl! 🐺",
    "Kurt seni çağırıyor, acele et! 🐺",
    "Hadi kurta gel, oyun zamanı! 🐺"
]
# tabu_messages.py
tabu_messages = [
    "Tabu oyunu başlıyor! Hazır mısın? 🎲",
    "Hadi tabuyu başlatalım! 🕹️",
    "Seni Tabu oyununa davet ediyorum! 🎯",
    "Tabu zamanı! Katılmaya ne dersin? 🧩",
    "Oyuna başlamak için hazırsan gel! 🎮",
    "Tabu oyununda seninle oynayacağım! 🕹️",
    "Hadi Tabu peşine düşelim! 🎲",
    "Tabu seni bekliyor! 🧩",
    "Oyuna katıl, eğlence başlasın! 🎯",
    "Tabu zamanı geldi, acele et! 🎮",
    "Seninle Tabu oynayacağız! 🕹️",
    "Tabu oyununa davetlisin! 🎲",
    "Hazır mısın? Tabu başlıyor! 🎮",
    "Hadi gel ve Tabu'yu başlat! 🧩",
    "Tabu zamanı, eğlenmeye hazır ol! 🎯",
    "Seninle oyun oynayacağız! 🕹️",
    "Tabu seni çağırıyor! 🎲",
    "Oyuna başla ve kazan! 🎮",
    "Tabu zamanı başladı! 🧩",
    "Gel ve Tabu'yu oyna! 🎯",
    "Tabu seni bekliyor, acele et! 🎲",
    "Hadi Tabu başlasın! 🕹️",
    "Seninle Tabu oynayacağım! 🎮",
    "Tabu oyununa davetlisin! 🧩",
    "Hazır mısın? Tabu zamanı! 🎯",
    "Gel ve eğlenceye katıl! 🎲",
    "Tabu zamanı başladı! 🎮",
    "Hadi Tabu'yu başlatalım! 🕹️",
    "Seninle oyun zamanı! 🧩",
    "Tabu seni bekliyor! 🎯",
    "Oyuna katıl ve kazan! 🎲",
    "Tabu zamanı, haydi gel! 🎮",
    "Hadi Tabu başlasın! 🕹️",
    "Seninle Tabu oynayacağız! 🧩",
    "Tabu oyununa davetlisin! 🎯",
    "Hazır mısın? Eğlence başlıyor! 🎲",
    "Gel ve Tabu'yu oyna! 🎮",
    "Tabu zamanı başladı! 🕹️",
    "Hadi Tabu başlasın! 🧩",
    "Seninle oyun zamanı! 🎯",
    "Tabu seni bekliyor, acele et! 🎲",
    "Oyuna katıl ve kazan! 🎮",
    ...
    "Tabu oyununa davetlisin! 🎲",
    "Hazır mısın? Eğlence başlıyor! 🎮",
    "Gel ve Tabu'yu oyna! 🕹️",
    "Tabu zamanı başladı! 🧩",
    "Hadi Tabu başlasın! 🎯",
    "Seninle oyun zamanı! 🎲",
    "Tabu seni bekliyor! 🎮",
    "Oyuna katıl ve kazan! 🕹️"
]
# anonim_messages.py
anonim_messages = [
    "Anonim oyunu başlıyor! Hazır mısın? 🎭",
    "Seni Anonim oyununa davet ediyorum! 🕹️",
    "Anonim zamanı! Katılmaya ne dersin? 🎲",
    "Oyuna başlamak için hazırsan gel! 🎯",
    "Anonim oyununda seninle oynayacağız! 🧩",
    "Hadi Anonim peşine düşelim! 🎮",
    "Anonim seni bekliyor! 🕹️",
    "Oyuna katıl, eğlence başlasın! 🎭",
    "Anonim zamanı geldi, acele et! 🎲",
    "Seninle Anonim oynayacağız! 🧩",
    "Anonim oyununa davetlisin! 🎯",
    "Hazır mısın? Anonim başlıyor! 🎮",
    "Hadi gel ve Anonim'i başlat! 🕹️",
    "Anonim zamanı, eğlenmeye hazır ol! 🎲",
    "Seninle oyun oynayacağız! 🎭",
    "Anonim seni çağırıyor! 🧩",
    "Oyuna başla ve kazan! 🎮",
    "Anonim zamanı başladı! 🎯",
    "Gel ve Anonim'i oyna! 🕹️",
    "Anonim seni bekliyor, acele et! 🎲",
    "Hadi Anonim başlasın! 🎮",
    "Seninle Anonim oynayacağım! 🧩",
    "Anonim oyununa davetlisin! 🎭",
    "Hazır mısın? Anonim zamanı! 🎲",
    "Gel ve eğlenceye katıl! 🎯",
    "Anonim zamanı başladı! 🎮",
    "Hadi Anonim'i başlatalım! 🕹️",
    "Seninle oyun zamanı! 🧩",
    "Anonim seni bekliyor! 🎭",
    "Oyuna katıl ve kazan! 🎲",
    "Anonim zamanı, haydi gel! 🎮",
    "Hadi Anonim başlasın! 🕹️",
    "Seninle Anonim oynayacağız! 🧩",
    "Anonim oyununa davetlisin! 🎯",
    "Hazır mısın? Eğlence başlıyor! 🎲",
    "Gel ve Anonim'i oyna! 🎭",
    "Anonim zamanı başladı! 🎮",
    "Hadi Anonim başlasın! 🕹️",
    "Seninle oyun zamanı! 🧩",
    "Anonim seni bekliyor, acele et! 🎯",
